...
function total(){
    ...
    for(let i = 1; i <= mes; i++){
        ...
        valor = resultado;
        //document.write("Mẽs " + i + "valor:" + moeda(resultado) + "<br>");
    }
    DocumentTimeline.getElementById("resultado").innerHTML = ("total; " + moeda(ressultado));
    
    //document.write("O Resultado é " + moeda(ressultado));
}
function soma(){
